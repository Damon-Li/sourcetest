...
namespace ModbusTCP
{
    public partial class FormEditRegister : Form
    {
        ...
        DisplayType m_Type;
        Form1 m_Form;
        CheckBox[] CheckBox_BinaryArray = new CheckBox[32];
                ...
                case 1:
                    switch (m_Type)
                    {
                        ...
                        case DisplayType.FloatDCBA:
                            ...
                            //n_NewData[0] = Convert.ToInt32(textBox1.Text);

                            //m_Form.myServer.SetData(RegisterType.HoldRegister, m_Index, n_NewData, m_Type);
